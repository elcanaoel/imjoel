...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.project-card, .skill-category, .stat, .about-text, .contact-info');
...
const debouncedScrollHandler = debounce(() => {
    ...
    if (window.scrollY > 50) {
        ...
        navbar.style.borderBottom = '1px solid rgba(148, 163, 184, 0.3)';
    } else {
        navbar.style.background = 'rgba(0, 0, 0, 0.98)';
